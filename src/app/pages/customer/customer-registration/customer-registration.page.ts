  ...
  constructor(public fb: FormBuilder, public customerService: CustomerService,
    ...
    public datePipe:DatePipe) { 
      ...
      this.customerDetails = this.activate.snapshot.data['data'] != null ? this.activate.snapshot.data['data'] :
                                                                            <Customer>{}  ;
      const altMobNumer: number = this.customerDetails.altMobileNo != null ? Number(this.customerDetails.altMobileNo) : null;
      const age = this.customerDetails.age != null ? this.customerDetails.age : null;
